...
Build {
	...
	Units = function ()
		...
		local libimgui_library = StaticLibrary {
			Name = "libimgui",
			Config = "*-*-*-*",
			Sources = { SourceGlob("source/main/cpp") },
			Includes = { "../libimgui/source/main/include","../xunittest/source/main/include" },
		}
		...
		local unittest = Program {
			...
			Includes = { "source/main/include","source/test/include","../xunittest/source/main/include","../xentry/source/main/include","../libimgui/source/main/include" },
			Depends = { libimgui_library,xunittest_library },
		}
		Default(unittest)
	end,
	Configs = {
